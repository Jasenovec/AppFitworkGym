...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: firebaseBom (33.7.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: playServicesAuth (21.3.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class GooglePluginAccessors extends PluginFactory {
        ...
        /**
         * Returns the group of plugins at plugins.google.android
         */
    ...
    public static class GoogleAndroidPluginAccessors extends PluginFactory {
        ...
        /**
         * Returns the group of plugins at plugins.google.android.libraries
         */
    ...
    public static class GoogleAndroidLibrariesPluginAccessors extends PluginFactory {
        ...
        /**
         * Returns the group of plugins at plugins.google.android.libraries.mapsplatform
         */
    ...
    public static class GoogleAndroidLibrariesMapsplatformPluginAccessors extends PluginFactory {
        ...
        /**
         * Returns the group of plugins at plugins.google.android.libraries.mapsplatform.secrets
         */
    ...
    public static class GoogleAndroidLibrariesMapsplatformSecretsPluginAccessors extends PluginFactory {
        ...
        /**
         * Returns the group of plugins at plugins.google.android.libraries.mapsplatform.secrets.gradle
         */
    ...
    public static class GoogleAndroidLibrariesMapsplatformSecretsGradlePluginAccessors extends PluginFactory {
        ...
        public GoogleAndroidLibrariesMapsplatformSecretsGradlePluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for google.android.libraries.mapsplatform.secrets.gradle.plugin to the plugin id 'com.google.android.libraries.mapsplatform.secrets-gradle-plugin'
             * This plugin was declared in catalog libs.versions.toml
             */
